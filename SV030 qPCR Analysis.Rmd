...
```{r}
roh <- read.csv2("C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Rohdaten/SV030 qPCR SBNO1.csv",sep=";", dec=".")

data <- roh[, c("Well.Position", "Sample.Name", "Target.Name", "CT")]
#View(data)

nmbr_of_samples = 7 #including control (control should be last)
nmbr_of_targets = 7 #including housekeeper, colors in qqplot chunk need to be adjusted!
nmbr_of_replicates = 3
name_housekeeper = "SRSF4"
name_normalize = "FLAG" # name of the sample you want to use for normalization
name_normalize2 = "empty"# name of a second sample you want to use for normalization
targets_norm2 <- c("SBNO1 CO")
...
To cancel out replicates that do not fit the other two, we compare the sd to the difference between CT-mean and CT-value of the sample. If the difference between CT-mean and CT-value is higher than a certain value, the samples are excluded.
...
Now we make beautiful ggplots and save them into our directory :)
```{r}
...
qPCR_bar_plots <- list()
colors_fill <- c("indianred1", "darkseagreen1", "lightblue1", "steelblue1", "indianred1", "indianred1", "khaki1")
colors_contour <- c("firebrick4", "seagreen4", "lightblue4", "steelblue4", "firebrick4", "firebrick4", "goldenrod2")

directory <- c("C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS dsRed1.svg",
               "C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS EGFP.svg",
               "C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS CO SBNO1.svg",
               "C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS SRSF4.svg",
               "C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS dsRed2.svg",
               "C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS dsRed3.svg",
               "C:/Users/sylvi/Documents/0. Arbeit/Studium/Bachelorarbeit/Abbildungen/R Plots/qPCR TS end SBNO1.svg")
...
for (i in c(1:nmbr_of_targets)){
  ...
  print(qPCR_bar_plots[[i]])
  ggsave(directory[i], plot = qPCR_bar_plots[[i]], width = 8, height = 5)
}
